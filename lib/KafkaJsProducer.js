 ...
 */
  ...
  * @param {Number} [compression=CompressionTypes.None] Compression codec, it use none compression as default. When pass `CompressionTypes.GZIP`, it will use gzip compression.
...
class KafkaJsProducer extends EventEmitter {
    ...
    _doSendBatch(needSendTopics, count) {
        const _this = this;
        _this.producer.sendBatch({
            topicMessages: needSendTopics,
            acks: this._acks,
